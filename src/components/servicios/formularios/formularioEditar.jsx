      ...
      setForm({
        ...
        duracion:
          ...
          service.duracion !== null
            ? String(service.duracion)
            : "",

        categoria_id:
          service.categoria_id !== undefined &&
          service.categoria_id !== null
            ? String(service.categoria_id)
            : "",
          ...
          <div>
            ...
            {service?.imagen_url && !imagenFile && (
              <div className="relative mt-4 group">
                <p className="text-xs text-slate-400 mb-2">Imagen actual en el sistema:</p>
                <img
                  src={service.imagen_url}
                  alt="Servicio actual"
                  className="h-40 w-full object-cover rounded-2xl border border-purple-500/20 transition-opacity duration-300 group-hover:opacity-90"
                />
              </div>
            )}
          </div>
